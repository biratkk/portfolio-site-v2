...
const Moon = () => (
  <motion.div className="cursor-pointer py-1 flex justify-center align-middle bg-slate-700 rounded-full w-6 h-6"
...
const Sun = () => (
  <motion.div className="cursor-pointer py-1 flex justify-center align-middle bg-white rounded-full w-6 h-6"
